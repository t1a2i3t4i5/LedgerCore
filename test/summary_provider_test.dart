...
///
/// **`SummaryProvider` は集計タブと精算タブで 1 インスタンスを共有する**
/// （`main.dart` の MultiProvider）。集計タブのモードを理由に割り勘のデータを
/// 落とすと、精算タブを開いた人に「データがありません」が出る。
...
void main() {
  ...
  group('精算タブとの共有', () {
    // このテストがこのファイルの主目的。SummaryProvider は集計タブと精算タブで
    ...
    // 実測で踏んだ事故そのもの。年を送ったら精算タブが 2026年7月 / ¥700 から
    // 2025年7月 / ¥250 に化けた（ユーザーは精算タブで何も操作していない）。
